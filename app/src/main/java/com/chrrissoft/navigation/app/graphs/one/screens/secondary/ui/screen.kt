package com.chrrissoft.navigation.app.graphs.one.screens.secondary.ui
...
@Composable
fun SecondaryScreenGraphOneUI(
    arguments: SecondaryScreenGraphOneArguments,
    ...
    onNavigatePrimaryScreen: (PrimaryScreenGraphOneArguments, NavOptions) -> Unit,
        ...
        destinationChooser = {
            DestinationChooser(
                ...
                onNavigateDestinationThree = {
                    val custom = GraphTwoArgument.from("secondary")
                    val required = random()
