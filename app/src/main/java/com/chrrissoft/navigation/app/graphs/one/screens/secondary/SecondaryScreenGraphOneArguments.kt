...
import com.chrrissoft.navigation.app.graphs.one.screens.secondary.SecondaryScreenGraphOneArgument.Companion.default
...
data class SecondaryScreenGraphOneArguments(
    val required0: Int,
    val required1: Int,
    val custom0: SecondaryScreenGraphOneArgument,
    val custom1: SecondaryScreenGraphOneArgument,
    val optional0: Int = optionalDefault,
    val optional1: Int = optionalDefault,
) : SecondaryScreenGraphOneArgumentsKeysHolder(), ArgumentsHolder {
    ...
    companion object {
        ...
        val instance = SecondaryScreenGraphOneArguments((0), (0), default, default)
    }
}
