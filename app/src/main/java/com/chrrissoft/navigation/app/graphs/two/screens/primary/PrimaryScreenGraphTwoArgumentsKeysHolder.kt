...
abstract class PrimaryScreenGraphTwoArgumentsKeysHolder : ArgumentsKeysHolder {
    protected val requiredKey0 = ArgumentKey<Int>("required_0")
    protected val requiredKey1 = ArgumentKey<Int>("required_1")
    protected val customKey0 = CustomArgumentKey<PrimaryScreenGraphTwoArgument>("custom_0")
    protected val customKey1 = CustomArgumentKey<PrimaryScreenGraphTwoArgument>("custom_1")
