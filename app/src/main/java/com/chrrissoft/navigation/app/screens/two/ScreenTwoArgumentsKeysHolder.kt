...
abstract class ScreenTwoArgumentsKeysHolder : ArgumentsKeysHolder {
    protected val requiredKey0 = ArgumentKey<Int>("required_0")
    protected val requiredKey1 = ArgumentKey<Int>("required_1")
    protected val customKey0 = CustomArgumentKey<CustomScreenTwoArgument>("custom_0")
    protected val customKey1 = CustomArgumentKey<CustomScreenTwoArgument>("custom_1")
